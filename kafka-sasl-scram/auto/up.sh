...
docker volume create --name zk-sasl-scram-data > /dev/null
docker volume create --name zk-sasl-scram-txn-logs > /dev/null
docker volume create --name kafka-sasl-scram-data > /dev/null
